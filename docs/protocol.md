        # Bapmr: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/bapmr.git

        ## Objective

        BAPMR (Bayesian Adaptive Prior Meta-Regression) implements adaptive Bayesian meta-regression with data-driven prior selection for moderator analysis.
        ...
        - Code: https://github.com/mahmood726-cyber/bapmr.git
        - Dashboard: https://mahmood726-cyber.github.io/bapmr/
